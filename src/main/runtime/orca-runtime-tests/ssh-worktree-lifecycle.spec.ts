...
describe('OrcaRuntimeService', () => {
  ...
  it.each([
    ...
    // oxlint-disable-next-line typescript/consistent-type-assertions -- SAFETY: Existing runtime fixture supplies the store surface; only repository ownership is overridden.
    ...
    vi.spyOn(
      // oxlint-disable-next-line typescript/consistent-type-assertions -- SAFETY: Runtime implements this inherited resolver; the spy replaces only parent resolution.
    ...
    await expect(
      ...
      message: 'Parent workspace must belong to the same execution host.'
    })
